!(function (a, i) {
  ...
  (e < 2 || (2 === e && r < 6)) &&
    N('Moment Timezone requires Moment.js >= 2.6.0. You are using Moment.js ' + A.version + '. See momentjs.com'),
    (p.prototype = {
      _set: function (a) {
        (this.name = a.name),
          (this.abbrs = a.abbrs),
  ...
  (A.tz = C),
    ...
    (A.updateOffset = function (a, i) {
      var e,
        r = A.defaultZone;
      void 0 === a._z &&
        (r && k(a) && !a._isUTC && ((a._d = A.utc(a._a)._d), a.utc().add(r.parse(a), 'minutes')), (a._z = r)),
        a._z &&
          ((e = a._z.utcOffset(a)),
          Math.abs(e) < 16 && (e /= 60),
      ...
      return a
        ? ((this._z = S(a)),
          this._z
            ...
            : N('Moment Timezone has no data for ' + a + '. See http://momentjs.com/timezone/docs/#/data-loading/.'),
          this)
        : this._z
        ? this._z.name
        : void 0;
    ...
    (A.tz.setDefault = function (a) {
      return (
        (e < 2 || (2 === e && r < 9)) &&
          N('Moment Timezone setDefault() requires Moment.js >= 2.9.0. You are using Moment.js ' + A.version + '.'),
  ...
  return (
    '[object Array]' === Object.prototype.toString.call(D) ? (D.push('_z'), D.push('_a')) : D && (D._z = null),
    _({
      version: '2018e',
      zones: [
