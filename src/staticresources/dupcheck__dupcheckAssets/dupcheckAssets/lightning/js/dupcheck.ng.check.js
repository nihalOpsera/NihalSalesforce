...
angular
  ...
  .controller('checkController', function ($scope, $rootScope, remoting) {
    ...
    $scope.helpPage =
      dc3Translate('URL_SUPPORT_USAGE_DC_CHECK', 'https://support.duplicatecheck.com') +
  ...
  .controller('resultController', function ($scope, $rootScope, remoting) {
    $scope.init = function () {
      $scope.resultCount = 0;
      $scope.searchResult;
      $scope.objectMeta;
      $scope.mergeSelected = 0;
    ...
    $scope.goBack = function () {
      dcNavigateRecord($rootScope.endpoint.objectId);
    };
