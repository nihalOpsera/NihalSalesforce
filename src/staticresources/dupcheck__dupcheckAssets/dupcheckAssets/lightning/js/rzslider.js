/* BEWARE! THIS FILE CONTAINS CUSTOM MODIFICATIONS DONE BY PLAUTI. DO NOT UPDATE! */
/* BEWARE! THIS FILE CONTAINS CUSTOM MODIFICATIONS DONE BY PLAUTI. DO NOT UPDATE! */
/* BEWARE! THIS FILE CONTAINS CUSTOM MODIFICATIONS DONE BY PLAUTI. DO NOT UPDATE! */
/* BEWARE! THIS FILE CONTAINS CUSTOM MODIFICATIONS DONE BY PLAUTI. DO NOT UPDATE! */
      ...
      function ($timeout, $document, $window, $compile, RzSliderOptions, rzThrottle) {
        ...
        Slider.prototype = {
          ...
          applyOptions: function () {
            ...
            if (angular.isNumber(this.options.showTicks)) this.intermediateTicks = true;
         ...
         */
          ...
          isTickSelected: function (value) {
            if (!this.range) {
              if (this.options.showSelectionBarFromValue !== null) {
                ...
                if (value >= this.scope.rzSliderModel) return true;
              } else if (this.options.showSelectionBar && value <= this.scope.rzSliderModel) return true;
            }
            if (this.range && value >= this.scope.rzSliderModel && value <= this.scope.rzSliderHigh) return true;
            return false;
          },
          ...
          updateHandles: function (which, newOffset) {
            if (which === 'rzSliderModel') this.updateLowHandle(newOffset);
            else this.updateHighHandle(newOffset);
          ...
          shFloorCeil: function () {
            var flHidden = false,
              ...
              isMinLabAtFloor = isRTL
                ? minLabPos + minLabDim >= flrLabPos - flrLabDim - 5
                : minLabPos <= flrLabPos + flrLabDim + 5,
              isMinLabAtCeil = isRTL
                ? minLabPos - minLabDim <= ceilLabPos + halfHandle + 10
                : minLabPos + minLabDim >= ceilLabPos - halfHandle - 10,
              isMaxLabAtFloor = isRTL
                ? maxLabPos >= flrLabPos - flrLabDim - halfHandle
                : maxLabPos <= flrLabPos + flrLabDim + halfHandle,
              isMaxLabAtCeil = isRTL
                ? maxLabPos - maxLabDim <= ceilLabPos + 10
                : maxLabPos + maxLabDim >= ceilLabPos - 10;
              ...
              if (this.options.showSelectionBarFromValue !== null) {
                var center = this.options.showSelectionBarFromValue,
                  ...
                  isModelGreaterThanCenter = this.options.rightToLeft
                    ? this.scope.rzSliderModel <= center
                    : this.scope.rzSliderModel > center;
          ...
          getEventXY: function (event) {
            ...
            return event.originalEvent === undefined
              ...
              : event.originalEvent.touches[0][clientXY];
          },
          ...
          getNearestHandle: function (event) {
            ...
            //reverse in rtl
            else return offset > this.minH.rzsp ? this.minH : this.maxH;
          },
          ...
          getValue: function (type, newOffset, outOfBounds, isAbove) {
            ...
            if (type === 'min') {
              if (outOfBounds) {
                ...
                value = isRTL
                  ? this.offsetToValue(newOffset + this.dragging.lowLimit)
                  : this.offsetToValue(newOffset - this.dragging.lowLimit);
              }
            } else {
              if (outOfBounds) {
          ...
          applyMinRange: function (newValue) {
            if (this.options.minRange !== 0) {
              var oppositeValue =
                  this.tracking === 'rzSliderModel' ? this.scope.rzSliderHigh : this.scope.rzSliderModel,
                difference = Math.abs(newValue - oppositeValue);

              if (difference < this.options.minRange) {
                if (this.tracking === 'rzSliderModel') return this.scope.rzSliderHigh - this.options.minRange;
