    ...
    .provider('$sanitize', function () {
      ...
      K = function (a, e) {
        ...
        for (b = d.firstChild; b; ) {
          ...
          if (
            !(k = b.firstChild) &&
            (1 === b.nodeType && e.end(b.nodeName.toLowerCase()), (k = v('nextSibling', b)), !k)
          )
            for (; null == k; ) {
              b = v('parentNode', b);
              if (b === d) break;
      ...
      var z = /[\uD800-\uDBFF][\uDC00-\uDFFF]/g,
        ...
        N = (function (a, e) {
          ...
          var g;
          if (e && e.implementation) g = e.implementation.createHTMLDocument('inert');
          ...
          return c.querySelector('svg')
            ? ((c.innerHTML = '<svg><p><style><img src="</style><img src=x onerror=alert(1)//">'),
