...
var PDFFindBar = (function PDFFindBarClosure() {
  function PDFFindBar(options) {
	...
	this.findCount = options.findCount || null;
	...
	this.findField.addEventListener('click', function() {
      self.dispatchEvent('');
    });
  ...
  PDFFindBar.prototype = {
    ...
    updateResultsCount: function(matchCount) {
      ...
      if (!matchCount) {
		this.findResultsCount.textContent = 0;
...
(function (root, factory) {
  {
    factory((root.pdfjsWebApp = {}), root.pdfjsWebUIUtils,
      root.pdfjsWebFirefoxCom, root.pdfjsWebPreferences,      
...
}(this, function (exports, uiUtilsLib, firefoxComLib, preferencesLib, 
                  pdfViewerLib, pdfRenderingQueueLib, pdfLinkServiceLib,
                  pdfFindControllerLib, pdfFindBarLib,
...
var PDFViewerApplication = {
  ...
  load: function pdfViewLoad(pdfDocument, scale) {
    ...
    firstPagePromise.then(function(pdfPage) {
	  ...
	  //set initial View
	  self.setInitialView(null, { scale: '1.0' });
...
function webViewerInitialized() {
  ...
  validateFileURL(file);
	...
	if ('search' in params) {
		...
		if(searchParam !== null && searchParam !== '' && typeof searchParam !== 'undefined' && typeof searchParam !== undefined) {
...
*/
  ...
  appConfig.toolbar.next.addEventListener('click',
	...
	appConfig.toolbar.clearText.addEventListener('click', function() {
	clearText();
});
...
document.addEventListener('pagerendered', function (e) {
  ...
  var pageView = PDFViewerApplication.pdfViewer.getPageView(pageIndex);
	...
	if (searchParamFound && pageNumber < 2) {		
		searchPDF(searchParam);
	}  
