({
	doInit : function(component, event, helper) {
        ...
        let tableColumns = [
            ...
            {label: 'Product', fieldName: 'Product', type: 'text', sortable: 'true', searchable: 'true'},
            ...
            case 'link':
                ...
                if(selected.length > 0) {
        		    ...
        		    for(let i = 0; i < selected.length; i++) {
                        if(selected[i].CH_Status__c === 'Inactive') {
                            linkList = [...linkList, {
                                Id : selected[i].Id,
                        ...
                        else return helper.showToast('error', 'Error', 'One or more of the selected Network Element Assets are already linked.');
                    }
            ...
            case 'unlink':
                ...
                if(selected.length > 0) {
        		    ...
        		    for(let i = 0; i < selected.length; i++) {
                        ...
                        else return helper.showToast('error', 'Error', 'One or more of the selected Network Element Assets are already unlinked.');
                    }
    ...
    handleRowAction: function (component, event, helper) {
        switch(event.getParam('action')) {
            case 'unlink':
                ...
                else helper.showToast('error', 'Error', 'Network Element Asset is already unlinked.');
                break;
        }
    },
