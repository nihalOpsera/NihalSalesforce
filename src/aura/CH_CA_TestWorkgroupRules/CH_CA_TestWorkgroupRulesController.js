({
    ...
    Search : function(component,event) {
        ...
        if(serviceType == 'Hardware Support' && (workgroupType !='Quotation Only' && workgroupType != 'Warranty Only' && workgroupType != 'Warranty and Quotation' && workgroupType != '') ){
            document.getElementById("workgrouptypeId").innerHTML = 'Please select "Warranty Only" or "Quotation Only" or "Warranty and Quotation"';
