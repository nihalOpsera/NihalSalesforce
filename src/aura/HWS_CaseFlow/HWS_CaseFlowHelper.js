    ...
    getVersionItems: function(component, event, helper) {
        ...
        getSellableItems: function(component,event,helper){
            ...
            deliveryInfo: function(component, event, helper) {
                ...
                if(caseOrigin == null || caseOrigin == undefined || caseOrigin == '' || caseOrigin == '--None--'){
                    this.hideWaiting(component);
                    ...
                    component.find("caseOriginMsg").set("v.errors", [{message: null}]);
                    $A.util.removeClass(component.find("caseOriginMsg"), 'slds-has-error');
                    isValidEmail = false;
                    
                } 
                if(EmailFeildShipEmail == null || EmailFeildShipEmail == undefined || EmailFeildShipEmail == '' || EmailFeildShipEmail =='undefined'){
   					console.log('******'+EmailFeildShipEmail);
                    this.hideWaiting(component);
                    ...
                    component.find("ShipRecipntEmailMsg").set("v.errors", [{message: null}]);
                    $A.util.removeClass(component.find("ShipRecipntEmailMsg"), 'slds-has-error');
                    isValidEmail = false;
                } 
                console.log('phoneValue1======='+phoneValue1);
                if (phoneValue1 == null || phoneValue1 == undefined || phoneValue1 == 'undefined' || phoneValue1 == '') {
                    this.hideWaiting(component);
                    console.log('Inside phone======='+phoneValue1);
                    ...
                    component.find("phoneMsg").set("v.errors", [{message: null}]);
                    $A.util.removeClass(component.find("phoneMsg"), 'slds-has-error');
                    isValidEmail = false;
                }
                console.log('ShipmentName======='+ShipmentName);
                if (ShipmentName == null || ShipmentName == undefined || ShipmentName == 'undefined' || ShipmentName == '') {
                    this.hideWaiting(component);
                    ...
                    component.find("ShipRecipntMsg").set("v.errors", [{message: null}]);
                    $A.util.removeClass(component.find("ShipRecipntMsg"), 'slds-has-error');
                    isValidEmail = false;
                }
                ...
                if(!$A.util.isEmpty(ShiptopartyAddress) && phoneNoValidation 
                   && Emailvalidation 
                   && caseOrigin != '--None--' 
			...
			getPayPerUse : function(component,event,helper){
             ...
             if(childCaseList != null){
                            for(var i=0;i<childCaseList.length;i++){
                                ...
                                console.log('InvoicingType'+InvoicingType);
                ...
                save: function(component, event, helper) {        
					...
					if(buttonName == 'saveAndSubmit' && (getPO==null || getPO=='' || getPO==undefined ||getPO=='undefined') && isInvoiceType) {
                        ...
                        this.showToast('error','Error Message','Please enter Customer Purchase Order Number on previous screen, or save as Draft and escalate to Customer Care Manager.');
                        this.hideWaiting(component);
                        ...
                        action.setCallback(this, $A.getCallback(function (response) {
                            ...
                            if (state === "SUCCESS") {					
                                ...
                                else
                                {
                                    //NOKIASC-34199
                                    if(fromSaveNReviewBtn){
                                        this.showToast('success','Success Message','Items are saved successfully , please check Review tab for details before submitting');
                                    }
                                    else{
                                ...
                                if(dateChangeValidate && duplicateSerialnumCheck && emailValidation && phoneValidation && detectionDateValidation && (faultSerialfromApex.toUpperCase() == 'NO' || ((faultSerialfromApex.toUpperCase() == 'YES' && serialNumber != undefined && serialNumber != '' && serialNumber != null) || serviceTypeCheck == 'Advanced Exchange in Hours')) && (((serviceTypeCheck == 'Return for Repair or Replacement' || serviceTypeCheck == 'Identical Repair' || serviceTypeCheck == 'Advanced Exchange in Days') && ((failureOccurrence != '--None--' && failureOccurrence != undefined && failureOccurrence != '') && (failureDetection != '--None--' && failureDetection != undefined && failureDetection != '') && (failureDescription != '--None--' && failureDescription != undefined && failureDescription != '') && (failureDetectionDate != '--None--' && failureDetectionDate != undefined && failureDetectionDate != ''))) || (serviceTypeCheck == 'Advanced Exchange in Hours'))){
                                   ...
                                   // this.childCaseCreation(component, event);
                                    ...
                                    if(serviceTypeCheck != 'Advanced Exchange in Hours' && ((failureOccurrence == '--None--' || failureOccurrence == undefined || failureOccurrence == '') || (failureDetection == '--None--' || failureDetection == undefined || failureDetection == '') || (failureDescription == '--None--' || failureDescription == undefined || failureDescription == '') || (failureDetectionDate == '--None--' || failureDetectionDate == undefined || failureDetectionDate == ''))){
                                        this.showToast('error','Error Message','Please select Failure Occurrence, Failure Detection and Failure Description Values'); 
                                        component.set("v.childcasestep4", false);
                                    }
	...
	**************************************************/	
	validateSWSCase: function(component, event, helper){	
        ...
        updateWarrantyStatusForRFRServiceType: function(component,event) {
            ...
            console.log('WARRANTY CHCK OUTSIDE'+isTraceble+'selectedAssets[0].HWS_ContractLineItem__r.HWS_InvoicingType__c:'+selectedAssets[0].HWS_ContractLineItem__r.HWS_InvoicingType__c+
                        'selectedAssets[0].HWS_ContractLineItem__r.HWS_WarrantyVerificationRequired__c:'+selectedAssets[0].HWS_ContractLineItem__r.HWS_WarrantyVerificationRequired__c+
                        'selectedAssets[0].HWS_ContractLineItem__r.HWS_QuotationRequiredFlag__c:'+selectedAssets[0].HWS_ContractLineItem__r.HWS_QuotationRequiredFlag__c);
            //var isTraceble ="YES";     
            if(isTraceble != null && isTraceble != '' && isTraceble != undefined  
               ...
               && (isTraceble.toUpperCase() == 'YES' || isTraceble.toUpperCase() == 'Y')){
                ...
                var action =component.get("c.warrantyCheck");
                 // NOKIASC-35543 | Start
                var materialCode = '';
                if(selectedAssets[0].HWS_SourceSystem__c != undefined && selectedAssets[0].HWS_SourceSystem__c =='Puma1' ){
                    materialCode=selectedVersions[0].Name;
                }
                else
