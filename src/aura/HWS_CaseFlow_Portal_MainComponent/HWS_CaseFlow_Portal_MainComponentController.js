    ...
    handleLookupEvent: function(component, event, helper) {
     ...
     handleComponentEvent : function(component, event, helper){       
		...
		if(showSection === 1){
            ...
            console.log('selectedAccNum==='+selectedAccNum);
		...
		if(showSection === 6){
            ...
            console.log('OLD::'+JSON.stringify(component.get("v.oldContractNumberRec"))+'NEW:::'+JSON.stringify(component.get("v.selectedContractLineItem")));
