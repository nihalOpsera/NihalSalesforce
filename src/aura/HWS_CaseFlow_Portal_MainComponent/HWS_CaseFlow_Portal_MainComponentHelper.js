({
    ...
    warrantyCheckHelper: function(component,event,parentCheck) {
        ...
        var serviceType = component.get('v.serviceType');  
		//34214
        if(isTraceble != null && isTraceble != '' && isTraceble != undefined && (serviceType == 'Return for Repair or Replacement' || serviceType == 'Advanced Exchange in Days' || serviceType == 'Identical Repair' || serviceType == 'Spare Part Sales') 
