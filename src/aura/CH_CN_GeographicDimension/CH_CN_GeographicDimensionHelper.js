({
    ...
    setCountryTable : function (component,event,helper){        
        component.set('v.countryColumns', [
            {label: 'Country Name', fieldName: 'Country_Name__c', type: 'text',sortable: 'true',searchable: 'true'},
            {label: 'Country Code', fieldName: 'Name', type: 'text',sortable: 'true',searchable: 'true' },
            {label: 'Market', fieldName: 'Market__c', type: 'text',sortable: 'true',searchable: 'true' }
        ]); 
    },
            ...
            if (state1 === "SUCCESS") {
                ...
                if(countryList !=null && countryList !='' && countryList!=undefined){
                    for(var i = 0; i < countryList.length; i++) {
                        countryList.Country_Name__c=countryList[i].Country_Name__c;
                        countryList.Name=countryList[i].Name;
                        countryList.Market__c=countryList[i].Market__c;
                    } 
                    //call data table                              
    ...
    resetSelectedTable: function(component, event, helper){
        ...
        if(selectedCountries != null && selectedCountries !='' && selectedCountries !=undefined){
            ...
            {
                var rowDataIndex=selectedOpsLst.map(function(e) { return e; }).indexOf(selectedCountries[i].Market__c); 
                if (rowDataIndex !=-1){
        ...
        if(removedCountries != null && removedCountries !='' && removedCountries !=undefined){
            ...
            for(var i=0;i<arrayLength;i++)
            {
                var rowDataIndex=selectedOpsLst.map(function(e) { return e; }).indexOf(removedCountries[i].Market__c); 
                if (rowDataIndex !=-1){
