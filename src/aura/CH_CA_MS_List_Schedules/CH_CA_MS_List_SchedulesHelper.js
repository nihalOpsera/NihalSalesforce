({
            ...
            columnDefs: [{
                    ...
                    title: 'Active'
					 ...
					 mRender: function (data, type, full) {
						 ...
						 return '<input class="slds-input" type="datetime" readonly value="' +  date.toLocaleDateString(component.get('v.userLocale'),{ timeZone: 'UTC'})  + '" />';  
					 },
					 type: 'date',
					 targets: 3,
					 width: '10em',
					 ...
					 mRender: function (data, type, full) {                    
						 var date = new Date(data);                                           
						 return  date.toString()!="Invalid Date"? date.toLocaleTimeString(component.get('v.userLocale'),{ timeZone: 'UTC'}):"Invalid Time" ;                       
					 },
					 width: '10em',
					 targets: 4,
					 title: 'Start Time',
    ...
    readTimeSlotFile: function(component, helper, file) {
        ...
        if(!file.name.match(/\.(csv||CSV)$/)){
            ...
            helper.validateButtons(component,event,helper,"The Import Function is aborted due to InCorrect File Format. Please review your changes.","ERROR");   
            return;
        }
        else{
            ...
            reader.onload = function(e) {
                ...
                if(csvRow.length<=1){
                    helper.showToast("ERROR","",
                                     "The Import Function is aborted due to empty cell in the file to be imported. Please review your changes."
                                    );
                    component.set("v.openImport", false);
                    component.set("v.isColumnError",true);
                                ...
                                if(apiName!='' ||  apiName!= "undefined"){
                                    if(csvColumn[k]==""||csvColumn[k]== null||csvColumn[k] == undefined || csvColumn[k] =="undefined"){
                                        ...
                                        if(apiName.trim()=="operationType"&& (getOperationValue!="update"&&getOperationValue!="delete"&&getOperationValue!="unchanged")){
                                            helper.showToast("ERROR","","The Import Function is aborted due to data inconsistency, only update/delete/unchanged are allowed in the file to be imported. Please review your changes.");
                                            component.set("v.openImport", false);
                                            component.set("v.isColumnError",true);
                                            component.set("v.Spinner", false);
                                            break;
                ...
                if(!component.get("v.isColumnError")){
                    ...
                    .then(function(result){
                        ...
                        if(result){
                            component.set("v.openImport", false);
                            component.set("v.isColumnError",true);
                            helper.validateButtons(component,event,helper,"Import Function isn't allowed on active schedule. Please review your changes.","ERROR"); 
                        }
                        return result;
                    })
                    .then(function(result){
                        if(!component.get('v.isActiveSchedule')){
                            ...
                            action.setCallback(this, function(response) {
                                ...
                                if (state === "SUCCESS") {  
                                    ...
                                    component.set("v.openImport", false);
                                    component.set("v.isColumnError",true);
                                    helper.validateButtons(component,event,helper,"The Import Function is aborted due to inconsistencies in the file to be imported. Please review your changes.","ERROR");  
                                }
                ...
                for(var i=1;i<csvRow.length;i++){
                        ...
                        if(csvHeader.length==17){
                            for(var k=0;k<17;k++){
                                ...
                                if(apiName!='' ||  apiName!= "undefined"){
                                    if(csvColumn[k]==""||csvColumn[k]== null||csvColumn[k] == undefined || csvColumn[k] =="undefined"){
                                        helper.showToast("ERROR","","The Import Function is aborted due to empty cell in the file to be imported. Please review your changes.");
                                        component.set("v.openImport", false);
                                        component.set("v.isColumnError",true);
                                        component.set("v.Spinner", false);
                                        break;
                                        ...
                                        if(apiName.trim()=="operationType"&& (getOperationValue!="update"&&getOperationValue!="delete"&&getOperationValue!="insert"&&getOperationValue!="unchanged")){
                                            helper.showToast("ERROR","","The Import Function is aborted due to data inconsistency, only insert/update/delete/unchanged are allowed in the file to be imported. Please review your changes.");
                                            component.set("v.openImport", false);
                                            component.set("v.isColumnError",true);
                                            component.set("v.Spinner", false);
                                            break;
