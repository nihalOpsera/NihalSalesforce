...
({
 ...
 AcceptCPA : function(component, event, helper) {
     ...
     else
     {
         ...
         toastEvent.setParams({
                        "title": "Failure!",
                        "message": "Please do not fill the rejection cause when you are accepting the CPA",
                        "type": "error"
                    });
            ...
            if (state === "SUCCESS") {
               ...
               // alert('fecthed value' +storeResponse.CH_Free_text_box__c);
                ...
                if (value1==''){
                      ...
                      toastEvent.setParams({
                        "title": "Failure!",
                        "message": "Please fill the rejection cause before to put the status rejected.",
                        "type": "error"
                    });
                    toastEvent.fire();
                }
                 if (value1=='Other' && freeTextValue==null){
                      ...
                      toastEvent.setParams({
                        "title": "Failure!",
                        "message": "Please specify the value that misses in the pick-list in Free text box in Details when you put 'Other'. Thank you.",
                        "type": "error"
                    });
