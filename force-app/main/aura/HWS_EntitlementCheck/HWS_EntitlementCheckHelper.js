    ...
    init: function (component,event,helper) {
        ...
        action.setCallback(this, function(response) {
            ...
            if (state === "SUCCESS") {                
                ...
                if(checkStatus){
                     component.set("v.disableSplit",false);
...
$A.enqueueAction(action);	
    ...
    updateCaseValues : function(component, event, helper, row) {
        ...
        action.setCallback(this,function(response) {
            var state = response.getState();
            if(state == "SUCCESS"){
                //this.getWarrantyStatus(component, event, helper, row[0]);
                //component.set("v.isSpinner",false);// remove it 
        ...
        action.setCallback(this, $A.getCallback(function (response) {
            ...
            if (state === "SUCCESS") {
                ...
                toastEvent.setParams({
                    ...
                    messageTemplate: 'Selected child cases has been moved to new parent case.New Case Number {0}, Click Validate & Submit to process remaining cases.',
                    messageTemplateData: [
                        {
