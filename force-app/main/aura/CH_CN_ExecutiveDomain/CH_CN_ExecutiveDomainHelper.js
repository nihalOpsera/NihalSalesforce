        ...
        if(!isCountryAll){
            ...
            if(selectedCountry.length>0){                    
                selectedCountry.forEach(function(item) {
                    notificationSubscriptionChild.push({"CH_AttributeRecordID__c":item.Id,"CH_AttributeCode__c":item.Name,"CH_AttributeName__c":item.Country_Name__c,"CH_AttributeType__c":"Country"});                           
                })
            }     
        }
        //Account Dimension property assignment        
