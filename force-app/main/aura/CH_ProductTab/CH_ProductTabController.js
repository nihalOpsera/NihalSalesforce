    ...
    openProductPulldown : function(component, event, helper) {
        ...
        if(object === 'Case') {
            ...
            action.setParams({ "assetRecordId" : component.get("v.recordId"), fields : [
                'Product2Id', 'CH_ProductRelease__c', 'CH_ProductVariant__c', 'CH_Solution__c'
            ]});
        }
                ...
                if (response.getReturnValue() == '') {
                    ...
                    evt.setParams({
                        ...
                        componentAttributes:{
                            ...
                            object : object,
                            type : object === 'Asset'?'Minimal':(component.get("v.lockedFields")?'CompleteMinimalLocked':'Complete')
                        }            
                    });
                    evt.fire();
