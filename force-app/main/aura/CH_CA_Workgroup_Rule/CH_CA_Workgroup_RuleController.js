({
    ...
    submit: function(component,event,helper){
        ...
        if(serviceTypeValue == 'Hardware Support' && (workGrouptypeValue !='Quotation Only' && workGrouptypeValue != 'Warranty Only' && workGrouptypeValue != 'Warranty and Quotation' && workGrouptypeValue !='' && workGrouptypeValue != null) ){	
            document.getElementById("workgrouptypeId").innerHTML = 'Please select either "--None--" or "Warranty Only" or "Quotation Only" or "Warranty and Quotation"';
		}
        else{
